      ...
      <div className='container mx-auto px-6 py-8'>
        ...
        <div className='flex flex-col mt-8'>
          <div className='-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8'>
            <div className='align-middle inline-block min-w-full max-w-screen-xl shadow overflow-hidden sm:rounded-lg border-gray-200'>
              <table className='text-center min-w-full max-w-screen-xl'>
                <thead>
